...
{ /* begin class bUnwarpJ_ */
    ...
    private static int min_scale_deformation = 1;
    ...
    /** divergence weight */
    private static double  divWeight                  = 5e-4;
    /** curl weight */
    private static double  curlWeight                 = 5e-4;
    /** landmarks weight */
    ...
    private static boolean saveTransformation         = true;
    
    /** minimum image scale */
    private int     min_scale_image            = 0;
    /** stopping threshold */
    private static double  stopThreshold      = 1e-4;
    ...
    public static boolean isRichOutput() {
		return richOutput;
	}


	public static void setRichOutput(boolean richOutput) {
		bUnwarpJ_.richOutput = richOutput;
	}


	public static boolean isSaveTransformation() {
		return saveTransformation;
	}


	public static void setSaveTransformation(boolean saveTransformation) {
		bUnwarpJ_.saveTransformation = saveTransformation;
	}
	...
	/*Information about which int stands for which mode
